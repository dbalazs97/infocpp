	...
	render() {
		return (
			<Container>
				...
				<p>A forráskód példaprogrammal letölthető: <a href="download/string.cpp" download><Icon name={'file'}/> string.cpp</a></p>
				...
				<p>A forráskód példaprogrammal letölthető: <a href="download/vector.cpp" download><Icon name={'file'}/> vector.cpp</a></p>
